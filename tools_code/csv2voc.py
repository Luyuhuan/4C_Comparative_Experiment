...
#1.标签路径
csv_file = "E:/hnumedical/Compare_4CHeartData/test4C.csv"
saved_path = "E:/hnumedical/Compare_4CHeartData/VOCdevkit/VOC2007-test/"                #保存路径
image_save_path = "./JPEGImages/"
image_raw_path = "E:/hnumedical/Compare_4CHeartData/test_4C_pic/"
#2.创建要求文件夹
...
for filename,label in total_csv_annotations.items():
    ...
    try:
        ...
        print(filename,'has no attribute shape')
        continue
    #embed()
...
fval = open(txtsavepath+'/test.txt', 'w',encoding='utf-8')
...
# train_files,val_files = train_test_split(total_files,test_size=0.0,random_state=42)
# train_files = total_files
val_files = total_files
