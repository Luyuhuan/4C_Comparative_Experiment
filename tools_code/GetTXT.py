...
testpic = 'E:/hnumedical/4C_心尖心底胸骨旁_合并/testbox.txt'
        ...
        for x in annotations:
            ...
            for i in range(len(classname)):
                if classname[i] in class_mapping_1:
                    ...
                    testpictxt.writelines(file_dir+'/'+str(x)+','+str(xmin)+','+str(ymin)+','+str(xmax)+','+str(ymax)+','+class_mapping_1[classname[i]]+ '\n')
    if os.path.isdir(path):
        list_dir(path)
list_dir('E:/hnumedical/4C_心尖心底胸骨旁_合并/test')